...
function post_book()
{
	...
	if (!nkHasVisitor()) echo '<b>' . $GLOBALS['user']['nickName'] . '</b></td></tr>'; else echo "<input id=\"guest_name\" type=\"text\" name=\"name\" value=\"\" size=\"20\" maxlength=\"30\" /></td></tr>\n";
...
function index()
{
    global $nuked, $language, $bgcolor1, $bgcolor2, $bgcolor3, $user;
