...
if($hasAdminAccess === true) {
    ...
    function edit_user($id_user)
    {
        ...
        $dbuUser = ' SELECT niveau, pseudo, pass, url, mail, email, icq, msn, aim, yim, rang, team, team2, team3, country, game, avatar, signature, ids_group
                     FROM ' . USER_TABLE . '
                     WHERE id = "' . $id_user . '"';
        ...
        else
        {
            ...
            $dbuUserUpdate = ' UPDATE ' . USER_TABLE . '
                               SET team = "' . $team . '", team2 = "' . $team2 . '", team3 = "' . $team3 . '",
                                   ...
                                   signature = "' . $signature . '", ids_group = "' . $userGroup . '",
                                   main_group = "' . $groupMain . '"
                               WHERE id = "' . $id_user . '"';
    ...
    function main()
    {
        ...
        $dbuUserSelect = ' SELECT UT.id, UT.pseudo, UT.date, UT.main_group, ST.date, GR.name
                           FROM ' . USER_TABLE . ' as UT
