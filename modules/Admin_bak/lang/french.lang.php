...
$arrayAdminLang = array(
    ...
    '_PREFS'         => 'Préférences',
    '_POSITION'      => 'Position',
    '_MOVEUP'        => 'Déplacer vers le haut',
    '_MOVEDOWN'      => 'Déplacer vers le bas',
    '_SEND'          => 'Envoyer',
    '_NAVLINKS'      => 'Liens',
    ...
    #####################################
    'NOTIFICATION_SUCCESS' => 'Notification de succès',
...
define("_SELECTPAGE","Sélectionnez les pages où vous voulez que le bloc s'affiche");
...
define("_BACK","Retour");
define("_BLOCKSUCCES","Bloc ajouté avec succès.");
define("_BLOCKCLEAR","Bloc effacé avec succès.");
define("_BLOCKMODIF","Bloc modifié avec succès.");
define("_TEAM","Team");
define("_USER","User");
define("_ADMIN","Admin");
define("_ALL","Tous");
define("_DELBLOCK","Vous êtes sur le point de supprimer le bloc");
...
define("_COLOR_MOD_ENABLED", "Les modules activés sont en bleu");
