...
{
    global $nuked, $user, $bgcolor1, $bgcolor2, $bgcolor3, $img_width, $image_resize, $language;
    ...
    else if ($_REQUEST['orderby'] == "note" && nkIsModEnabled('Vote'))
    {
...
function classe()
{
    ...
    if ($count > 1 && $cat != "")
    {
        ...
        if ($_REQUEST['orderby'] == "note" && nkIsModEnabled('Vote'))
        {
            echo "<b>" . _NOTE . "</b>&nbsp;";
        }
        elseif (nkIsModEnabled('Vote'))
        {
